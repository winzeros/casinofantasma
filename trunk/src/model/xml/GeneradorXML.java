...
public class GeneradorXML {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            item.setAttribute(Vista.JUEGO, String.valueOf((int) (Math.random() * 7))); //Son 12 juegos
        ...
        for (int i = 0; i < 100; i++) {
            ...
            item.setAttribute(Vista.APUESTA, String.valueOf((int) (Math.random() * 100))); //Supongo que el coste máximo son 100 días
            root.addContent(item);
        }
