...
public class Vista {
    ...
    public static String ESTRATEGIA = "estrategia";
    ...
    public static String APUESTA = "apuesta";

    public static String SALAS_XML = "salas";
    public static String RECORRIDO_XML = "recorrido";
