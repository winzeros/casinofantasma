...
public class EightPuzzleEstados {
	...
	public EightPuzzleEstados() {
		tablero = new int[] { 1, 2, 5, 3, 4, 0, 6, 7, 8 };

	}

	public EightPuzzleEstados(int[] aBoard) {
		tablero = aBoard;
        }
	...
	public boolean equals(Object o) {
		...
		EightPuzzleEstados aBoard = (EightPuzzleEstados) o;
